...
public class EstoqueCRUD {
    ...
    public void insert(String nome, int quantidade, double valor, String uni_medida, String descricao) {
        String sql = "INSERT INTO `estoque` (`nome`, `quantidade`, `valor`, `uni_medida`, `descricao`)" +
                "VALUES (?, ?, ?, ?, ?)";
    ...
    public List<Model> getAll() {
        ...
        try (Connection connection = Connect.getConnection();
            ...
            while (resultSet.next()) {
                ...
                String uni_medida = resultSet.getString("uni_medida");
    ...
    public void update(int id, String nome, int quantidade, double valor, String uni_medida, String descricao) {
        String sql = "UPDATE `estoque` SET `nome` = ?, `quantidade` = ?, `valor` = ?, `uni_medida` = ?, `descricao` = ?, `updated_at` = CURRENT_TIMESTAMP WHERE `id` = ?";
